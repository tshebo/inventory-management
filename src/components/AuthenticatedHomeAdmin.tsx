...
import { Users, ShoppingBag, Calendar, Store, BarChart2, Settings, Menu } from 'lucide-react'
        ...
        <nav className="mt-8">
          {navItems.map((item) => (
            <Link key={item.name} href={item.href}>
              <span className={`flex items-center px-4 py-2 mt-2 text-gray-600 rounded-lg hover:bg-gray-200 ${
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <Input id="search-users" placeholder="Enter name or email" />
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <Input id="search-vendors" placeholder="Enter vendor name" />
                          <Button>Search</Button>
                        </div>
                        <div className="border rounded-lg p-4">
                          <h3 className="font-semibold mb-2">Vendor List</h3>
                          {/* Add vendor list table or grid here */}
                          <p className="text-muted-foreground">Vendor list will be displayed here.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <Input id="search-events" placeholder="Enter event name or date" />
                          <Button>Search</Button>
                        </div>
                        <div className="border rounded-lg p-4">
                          <h3 className="font-semibold mb-2">Event List</h3>
                          {/* Add event list table or grid here */}
                          <p className="text-muted-foreground">Event list will be displayed here.</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <Input id="search-products" placeholder="Enter product name" />
                          <Button>Search</Button>
                        </div>
                        <div className="border rounded-lg p-4">
